---
layout: post
title: "Xabi Alonso was the bigger swing, not the easier fit"
date: 2026-05-31
updated: 2026-05-31
thread_num: 2
status: live
status_label: "Live"
description: "Xabi Alonso's Liverpool appeal was real, but the data points to a high-upside tactical reset rather than a plug-and-play continuation of Klopp's squad logic."
excerpt: "Alonso was not a bad fit for Liverpool. He was the bigger tactical swing: elite, flexible, and high-upside, but less obviously low-disruption than the romance suggested."
social_image: "/assets/figures/the_attacking_contrast_final.png"
---
...
<figure class="post-figure">
  <img src="{{ '/assets/figures/the_shape_shifter_final.png' | relative_url }}" alt="Stacked formation comparison showing Liverpool and Slot as back-four continuity, Alonso's Leverkusen peak as a wing-back reset, and Alonso's Madrid evidence as a 19-match adaptation window" />
  <figcaption>Formation architecture: Klopp and Slot stay in a back-four world, while Alonso's Leverkusen peak points to a wing-back reset and his Madrid window shows a varied adaptation case.</figcaption>
</figure>
...
<figure class="post-figure">
  <img src="{{ '/assets/figures/the_attacking_contrast_final.png' | relative_url }}" alt="Understat 19-match comparison showing Alonso's Madrid window ahead of Slot's Liverpool first 19 on goals per match, xG difference per match and points per match" />
  <figcaption>A 19-match modern comparison: Alonso's Madrid window carried stronger chance balance and points output than Slot's first 19 league matches of Liverpool's 2025/26.</figcaption>
</figure>
...
<figure class="post-figure">
  <img src="{{ '/assets/figures/tactical_dna_final.png' | relative_url }}" alt="Style snapshot plotting passes per match against shots per match for Alonso's Leverkusen and Madrid teams and Klopp/Slot Liverpool cohorts, framed as broad style proxies" />
  <figcaption>Broad style proxies: Alonso's Leverkusen side was the pass-volume control outlier, while Madrid and Liverpool sit in different parts of the pass-shot map.</figcaption>
</figure>
...
<div class="post-footer-note">
  <p><strong>Data:</strong> SportsMonks API v3 (domestic formations, scores, league records, broad team-stat profiles) and Understat (xG, shot profile, PPDA).</p>
  <p><strong>Scope:</strong> Formation labels do not prove tactics in full. PPDA is a blunt pressing measure. The role-suitability discussion is a qualitative editorial layer, not tracking data or transfer reporting. This piece does not claim to know Liverpool's internal decision-making.</p>
  <p><strong>Madrid attribution:</strong> Real Madrid's <a href="https://www.realmadrid.com/en-US/news/club/announcements/comunicado-oficial-xabi-alonso-12-01-2026">official announcement dated 12 January 2026</a> said Alonso's time as first-team coach had ended by mutual agreement, though subsequent reporting (e.g. <a href="https://www.espn.com/soccer/story/_/id/47597821/why-real-madrid-sacked-manager-xabi-alonso-233-days">ESPN</a>) characterised it as a dismissal. This article therefore attributes only the auditable La Liga window to Alonso: 19 league matches from 19 August 2025 through 4 January 2026. The full Madrid 2025/26 record is not treated as Alonso's record.</p>
